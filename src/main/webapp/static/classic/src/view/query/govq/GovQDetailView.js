 ...
 */
Ext.define('app.view.query.govq.GovQDetailView', {
    extend: 'Ext.panel.Panel',
    xtype: 'govqdetailview',

    scrollable: true,
    requires: [
        'app.view.query.govq.GovQModel',
    ...
    tpl: Ext.create('Ext.XTemplate', [
        ...
        '<div><span>营业执照号码</span><span>{govq_id}</span></div>' +
        '<div><span>企业名称</span><span>{govq_nm}</span></div>' +
