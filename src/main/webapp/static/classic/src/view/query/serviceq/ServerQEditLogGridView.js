...
*/
Ext.define('app.view.query.serviceq.ServerQEditLogGridView', {
    ...
    columns: [
        ...
        {text: '数据ID', width: 60, dataIndex: 'srv_id',hidden:true},
        {text: '企业ID', width: 60, dataIndex: 'srv_corp_id',hidden:true},
