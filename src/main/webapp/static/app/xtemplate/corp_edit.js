...
var  corp_edit_con_tpl = new Ext.XTemplate(
    ...
    '<th>证监会行业一级分类</th>',
    '<td>    ',
    '<select  onchange="areaZjh(this.value)" class="select" name="csrc_type1" id="csrc_type1">',
    '<option>农、林、牧、渔业</option>' ,
    '<option>采矿业</option>' ,
    '<option>制造业</option>',
    ...
    '<th>行业一级分类</th>',
    '<td>',
    '<select onchange="inv_csrc_type1_select(this.value)" class="select" name="inv_csrc_type1" id="inv_csrc_type1">',
    '<option>农、林、牧、渔业</option>',
    '<option>采矿业</option>',
    '<option>制造业</option>',
    '<option>电力、燃气及水的生产和供应业</option>',
    ...
    '<th>行业二级分类</th>',
    '<td>',
    '<select onchange="inv_csrc_type2_select(this.value)"class="select" name="inv_csrc_type2" id="inv_csrc_type2">',
    ...
    '<th>行业三级分类</th>',
    '<td>',
    '<select onchange="inv_csrc_type3_select(this.value)" class="select" name="inv_csrc_type3" id="inv_csrc_type3">',
    ...
    '<th>证监会行业一级分类</th>',
    '<td>    ',
    '<select onchange="inv_indclass1_select(this.value)" class="select" name="inv_indclass1" id="inv_indclass1">',
    '<option>农、林、牧、渔业</option>' ,
    '<option>采矿业</option>' ,
    '<option>制造业</option>',
    '<option>电力、热力、燃气及水生产和供应业</option>' ,
