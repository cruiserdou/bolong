...
var corp_apply_con_tpl = new Ext.XTemplate(
    ...
    '<td><input id="buslicno"  name="buslicno"  type="text" onchange="card_check_apply(this);" /></td>',
    ...
    '<tr>',
    '<th>手机</th>',
    '<td><input id="cont_ephone" name="cont_ephone"  type="text" /></td>',
    '<th>传真</th>',
    '<td><input id="cont_efax" name="cont_efax"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>E-mail</th>',
    '<td><input id="cont_eemail" name="cont_eemail"  type="text" /></td>',
    '<th>QQ</th>',
    '<td><input id="cont_eqq" name="cont_eqq"  type="text" /></td>',
    '</tr>',
    '<tr>' +
    '<th>微信号</th>' +
    '<td><input id="cont_webchat" name="cont_webchat"  type="text" /></td>' +
    '<th>固话</th>',
    '<td><input id="cont_tel" name="cont_tel"  type="text" /></td>' +
    '</tr>' +
    '<tr>' +
    '<th>备注</th>' +
    ...
    '<tr>',
    '<th>固定电话</th>',
    '<td><input id="mai_tel" name="mai_tel"  type="text" /></td>',
    '<th>手机号码</th>',
    '<td><input id="mai_phone" name="mai_phone"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>传真</th>',
    '<td><input id="mai_fax" name="mai_fax"  type="text" /></td>',
    '<th>E-mail</th>',
    '<td><input id="mai_email" name="mai_email"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>QQ</th>',
    '<td><input id="mai_qq" name="mai_qq"  type="text" /></td>',
    '<th>微信号</th>',
    ...
    '<tr>',
    '<th>货币资金</th>',
    '<td><input id="st_money_fund" name="st_money_fund"  type="text" /></td>',
    '<td><input id="end_money_fund" name="end_money_fund"  type="text" /></td>',
    '<th>短期借款</th>',
    '<td><input id="st_short_borrow" name="st_short_borrow"  type="text" /></td>',
    '<td><input id="end_short_borrow" name="end_short_borrow"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>交易性金融资产</th>',
    '<td><input id="st_jyxjr_assets" name="st_jyxjr_assets"  type="text" /></td>',
    '<td><input id="end_jyxjr_assets" name="end_jyxjr_assets"  type="text" /></td>',
    '<th>交易性金融负债</th>',
    '<td><input id="st_jyx_finance_fz" name="st_jyx_finance_fz"  type="text" /></td>',
    '<td><input id="end_jyx_finance_fz" name="end_jyx_finance_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>应收票据</th>',
    '<td><input id="st_ys_bill" name="st_ys_bill"  type="text" /></td>',
    '<td><input id="end_ys_bill" name="end_ys_bill"  type="text" /></td>',
    '<th>应付票据</th>',
    '<td><input id="st_yf_bill" name="st_yf_bill"  type="text" /></td>',
    '<td><input id="end_yf_bill" name="end_yf_bill"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>应收账款</th>',
    '<td><input id="st_ys_account" name="st_ys_account"  type="text" /></td>',
    '<td><input id="end_ys_account" name="end_ys_account"  type="text" /></td>',
    '<th>应付账款</th>',
    '<td><input id="st_yf_account" name="st_yf_account"  type="text" /></td>',
    '<td><input id="end_yf_account" name="end_yf_account"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>预付款项</th>',
    '<td><input id="st_yf_money" name="st_yf_money"  type="text" /></td>',
    '<td><input id="end_yf_money" name="end_yf_money"  type="text" /></td>',
    '<th>预收款项</th>',
    '<td><input id="st_ys_money" name="st_ys_money"  type="text" /></td>',
    '<td><input id="end_ys_money" name="end_ys_money"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>应收利息</th>',
    '<td><input id="st_ys_interest" name="st_ys_interest"  type="text" /></td>',
    '<td><input id="end_ys_interest" name="end_ys_interest"  type="text" /></td>',
    '<th>应付职工薪酬</th>',
    '<td><input id="st_yf_staff_pay" name="st_yf_staff_pay"  type="text" /></td>',
    '<td><input id="end_yf_staff_pay" name="end_yf_staff_pay"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>应收股利</th>',
    '<td><input id="st_ys_dividends" name="st_ys_dividends"  type="text" /></td>',
    '<td><input id="end_ys_dividends" name="end_ys_dividends"  type="text" /></td>',
    '<th>应交税费</th>',
    '<td><input id="st_yj_tax" name="st_yj_tax"  type="text" /></td>',
    '<td><input id="end_yj_tax" name="end_yj_tax"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>其他应收款</th>',
    '<td><input id="st_other_ys_money" name="st_other_ys_money"  type="text" /></td>',
    '<td><input id="end_other_ys_money" name="end_other_ys_money"  type="text" /></td>',
    '<th>应付利息</th>',
    '<td><input id="st_yf_interest" name="st_yf_interest"  type="text" /></td>',
    '<td><input id="end_yf_interest" name="end_yf_interest"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>存货</th>',
    '<td><input id="st_inventory" name="st_inventory"  type="text" /></td>',
    '<td><input id="end_inventory" name="end_inventory"  type="text" /></td>',
    '<th>应付股利</th>',
    '<td><input id="st_yf_dividends" name="st_yf_dividends"  type="text" /></td>',
    '<td><input id="end_yf_dividends" name="end_yf_dividends"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>一年内到期非流动资产</th>',
    '<td><input id="st_ynndq_no_assets" name="st_ynndq_no_assets"  type="text" /></td>',
    '<td><input id="end_ynndq_no_assets" name="end_ynndq_no_assets"  type="text" /></td>',
    '<th>其他应付款</th>',
    '<td><input id="st_other_yf_money" name="st_other_yf_money"  type="text" /></td>',
    '<td><input id="end_other_yf_money" name="end_other_yf_money"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>其他流动资产</th>',
    '<td><input id="st_other_assets" name="st_other_assets"  type="text" /></td>',
    '<td><input id="end_other_assets" name="end_other_assets"  type="text" /></td>',
    '<th>一年内到期的非流动负债</th>',
    '<td><input id="st_ynndq_no_fz" name="st_ynndq_no_fz"  type="text" /></td>',
    '<td><input id="end_ynndq_no_fz" name="end_ynndq_no_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th></th>',
    '<th></th>',
    '<th></th>',
    '<th>其他流动负债</th>',
    '<td><input id="st_other_fz" name="st_other_fz"  type="text" /></td>',
    '<td><input id="end_other_fz" name="end_other_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>流动资产合计</th>',
    '<td><input id="st_hj_assets" name="st_hj_assets"  type="text" /></td>',
    '<td><input id="end_hj_assets" name="end_hj_assets"  type="text" /></td>',
    '<th>流动负债合计</th>',
    '<td><input id="st_hj_fz" name="st_hj_fz"  type="text" /></td>',
    '<td><input id="end_hj_fz" name="end_hj_fz"  type="text" /></td>',
    '</tr>',
    ...
    '<tr>',
    '<th>可供出售金融资产</th>',
    '<td><input id="st_kgcs_assets" name="st_kgcs_assets"  type="text" /></td>',
    '<td><input id="end_kgcs_assets" name="end_kgcs_assets"  type="text" /></td>',
    '<th>长期借款</th>',
    '<td><input id="st_long_borrow" name="st_long_borrow"  type="text" /></td>',
    '<td><input id="end_long_borrow" name="end_long_borrow"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>持有至到期投资</th>',
    '<td><input id="st_cyzdq_investment" name="st_cyzdq_investment"  type="text" /></td>',
    '<td><input id="end_cyzdq_investment" name="end_cyzdq_investment"  type="text" /></td>',
    '<th>应付债券</th>',
    '<td><input id="st_yf_bond" name="st_yf_bond"  type="text" /></td>',
    '<td><input id="end_yf_bond" name="end_yf_bond"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>长期应收款</th>',
    '<td><input id="st_long_ys_money" name="st_long_ys_money"  type="text" /></td>',
    '<td><input id="end_long_ys_money" name="end_long_ys_money"  type="text" /></td>',
    '<th>长期应付款</th>',
    '<td><input id="st_long_yf_money" name="st_long_yf_money"  type="text" /></td>',
    '<td><input id="end_long_yf_money" name="end_long_yf_money"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>长期股权投资</th>',
    '<td><input id="st_long_gq_investment" name="st_long_gq_investment"  type="text" /></td>',
    '<td><input id="end_long_gq_investment" name="end_long_gq_investment"  type="text" /></td>',
    '<th>专项应付款</th>',
    '<td><input id="st_zx_yf_money" name="st_zx_yf_money"  type="text" /></td>',
    '<td><input id="end_zx_yf_money" name="end_zx_yf_money"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>投资性房地产</th>',
    '<td><input id="st_invest_house" name="st_invest_house"  type="text" /></td>',
    '<td><input id="end_invest_house" name="end_invest_house"  type="text" /></td>',
    '<th>预计负债</th>',
    '<td><input id="st_yj_fz" name="st_yj_fz"  type="text" /></td>',
    '<td><input id="end_yj_fz" name="end_yj_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>固定资产</th>',
    '<td><input id="st_gd_assets" name="st_gd_assets"  type="text" /></td>',
    '<td><input id="end_gd_assets" name="end_gd_assets"  type="text" /></td>',
    '<th>递延所得税负债</th>',
    '<td><input id="st_dysds_fz" name="st_dysds_fz"  type="text" /></td>',
    '<td><input id="end_dysds_fz" name="end_dysds_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>减：累计折旧</th>',
    '<td><input id="st_accu_deprec" name="st_accu_deprec"  type="text" /></td>',
    '<td><input id="end_accu_deprec" name="end_accu_deprec"  type="text" /></td>',
    '<th>其他非流动负债</th>',
    '<td><input id="st_other_no_fz" name="st_other_no_fz"  type="text" /></td>',
    '<td><input id="end_other_no_fz" name="end_other_no_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>固定资产净值</th>',
    '<td><input id="st_gd_assets_jz" name="st_gd_assets_jz"  type="text" /></td>',
    '<td><input id="end_gd_assets_jz" name="end_gd_assets_jz"  type="text" /></td>',
    '<th>非流动负债合计</th>',
    ...
    '<tr>',
    '<th>减：固定资产减值准备</th>',
    '<td><input id="st_gd_assets_ready" name="st_gd_assets_ready"  type="text" /></td>',
    '<td><input id="end_gd_assets_ready" name="end_gd_assets_ready"  type="text" /></td>',
    '<th>负债合计</th>',
    '<td><input id="st_hj_total_fz" name="st_hj_total_fz"  type="text" /></td>',
    '<td><input id="end_hj_total_fz" name="end_hj_total_fz"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>固定资产净额</th>',
    '<td><input id="st_gd_assets_je" name="st_gd_assets_je"  type="text" /></td>',
    '<td><input id="end_gd_assets_je" name="end_gd_assets_je"  type="text" /></td>',
    '<th></th>',
    '<th></th>',
    '<th></th>',
    '</tr>',
    '<tr>',
    '<th>在建工程</th>',
    '<td><input id="st_now_project" name="st_now_project"  type="text" /></td>',
    '<td><input id="end_now_project" name="end_now_project"  type="text" /></td>',
    '<th>所有者权益(或股东权益)</th>',
    '<th></th>',
    '<th></th>',
    '</tr>',
    '<tr>',
    '<th>工程物资</th>',
    '<td><input id="st_project_material" name="st_project_material"  type="text" /></td>',
    '<td><input id="end_project_material" name="end_project_material"  type="text" /></td>',
    '<th>实收资本（或股本）</th>',
    '<td><input id="st_paid_assets" name="st_paid_assets"  type="text" /></td>',
    '<td><input id="end_paid_assets" name="end_paid_assets"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>固定资产清理</th>',
    '<td><input id="st_gd_assets_ql" name="st_gd_assets_ql"  type="text" /></td>',
    '<td><input id="end_gd_assets_ql" name="end_gd_assets_ql"  type="text" /></td>',
    '<th>资本公积</th>',
    '<td><input id="st_zb_reserve" name="st_zb_reserve"  type="text" /></td>',
    '<td><input id="end_zb_reserve" name="end_zb_reserve"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>生产性生物资产</th>',
    '<td><input id="st_scx_investment" name="st_scx_investment"  type="text" /></td>',
    '<td><input id="end_scx_investment" name="end_scx_investment"  type="text" /></td>',
    '<th>减：库存股</th>',
    '<td><input id="st_kc_stock" name="st_kc_stock"  type="text" /></td>',
    '<td><input id="end_kc_stock" name="end_kc_stock"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>无形资产</th>',
    '<td><input id="st_wx_assets" name="st_wx_assets"  type="text" /></td>',
    '<td><input id="end_wx_assets" name="end_wx_assets"  type="text" value="{end_wx_assets}"/></td>',
    '<th>专项储备</th>',
    '<td><input id="st_zx_reserve" name="st_zx_reserve"  type="text" /></td>',
    '<td><input id="end_zx_reserve" name="end_zx_reserve"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>商誉</th>',
    '<td><input id="st_goodwill" name="st_goodwill"  type="text" /></td>',
    '<td><input id="end_goodwill" name="end_goodwill"  type="text" /></td>',
    '<th>盈余公积</th>',
    '<td><input id="st_yy_reserve" name="st_yy_reserve"  type="text" /></td>',
    '<td><input id="end_yy_reserve" name="end_yy_reserve"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>长期待摊费用</th>',
    '<td><input id="st_cqdt_cost" name="st_cqdt_cost"  type="text" /></td>',
    '<td><input id="end_cqdt_cost" name="end_cqdt_cost"  type="text" /></td>',
    '<th>未分配利润</th>',
    '<td><input id="st_wfp_profit" name="st_wfp_profit"  type="text" /></td>',
    '<td><input id="end_wfp_profit" name="end_wfp_profit"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>递延所得税资产</th>',
    '<td><input id="st_dysds_assets" name="st_dysds_assets"  type="text" /></td>',
    '<td><input id="end_dysds_assets" name="end_dysds_assets"  type="text" /></td>',
    '<th>所有者权益合计</th>',
    '<td><input id="st_hj_owner_right" name="st_hj_owner_right"  type="text" /></td>',
    '<td><input id="end_hj_owner_right" name="end_hj_owner_right"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>其他非流动资产</th>',
    '<td><input id="st_other_no_assets" name="st_other_no_assets"  type="text" /></td>',
    '<td><input id="end_other_no_assets" name="end_other_no_assets"  type="text" /></td>',
    '<th></th>',
    '<th></th>',
    '<th></th>',
    '</tr>',
    '<tr>',
    '<th>非流动资产合计</th>',
    '<td><input id="st_hj_no_asset" name="st_hj_no_asset"  type="text" /></td>',
    '<td><input id="end_hj_no_asset" name="end_hj_no_asset"  type="text" /></td>',
    '<th></th>',
    '<th></th>',
    '<th></th>',
    '</tr>',
    '<tr>',
    '<th>资产总计</th>',
    '<td><input id="st_hj_total_asset" name="st_hj_total_asset"  type="text" /></td>',
    '<td><input id="end_hj_total_asset" name="end_hj_total_asset"  type="text" /></td>',
    '<th>负债和所有者权益合计</th>',
    '<td><input id="st_hj_fz_owner_right" name="st_hj_fz_owner_right"  type="text" /></td>',
    '<td><input id="end_hj_fz_owner_right" name="end_hj_fz_owner_right"  type="text" /></td>',
    '</tr>',
    '</table>',
    ...
    '<tr>',
    '<th>手机</th>',
    '<td><input id="inv_phone" name="inv_phone"  type="text" /></td>',
    '<th>传真</th>',
    '<td><input id="inv_fax" name="inv_fax"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>E-mail</th>',
    '<td><input id="inv_email" name="inv_email"  type="text" /></td>',
    '<th>QQ</th>',
    '<td><input id="inv_qq" name="inv_qq"  type="text" /></td>',
    '</tr>',
    '<tr>' +
    '<th>微信号</th>' +
    '<td><input id="inv_webchat" name="inv_webchat"  type="text" "/></td>' +
    '<th>固话</th>',
    '<td><input id="inv_tel" name="inv_tel"  type="text" /></td>' +
    '</tr>' +
    '<tr>' +
    '<th>备注</th>' +
    ...
    '<tr>',
    '<th>手机</th>',
    '<td><input id="gov_phone" name="gov_phone"  type="text" /></td>',
    '<th>传真</th>',
    '<td><input id="gov_fax" name="gov_fax"  type="text" /></td>',
    '</tr>',
    '<tr>',
    '<th>E-mail</th>',
    '<td><input id="gov_email" name="gov_email"  type="text" /></td>',
    '<th>QQ</th>',
    '<td><input id="gov_qq" name="gov_qq"  type="text" /></td>',
    '</tr>',
    '<tr>' +
    '<th>微信号</th>' +
    '<td><input id="gov_webchat" name="gov_webchat"  type="text" /></td>' +
    '<th>固话</th>',
    '<td><input id="gov_tel" name="gov_tel"  type="text" /></td>' +
    '</tr>' +
    '<tr>' +
    '<th>备注</th>' +
    ...
    '<tr>',
    '<th>可接受成本（%/年）</th>',
    '<td><input id="refi_acc_cost" name="refi_acc_cost"  type="text" /></td>',
    '<th>融资期限</th>',
